...
### APA 7ª Edición
```
de la Serna Tuya, J. M. (2026). GDP Evolution in Latin America 2000-2024: Interactive Dashboard. GitHub. https://github.com/juanmoisesd/gdp-latam-2000-2024
```

### Chicago Autor-Fecha
```
de la Serna Tuya, Juan Moisés. 2026. "GDP Evolution in Latin America 2000-2024: Interactive Dashboard." GitHub. https://github.com/juanmoisesd/gdp-latam-2000-2024.
```

### BibTeX
```bibtex
@misc{delaserna2026_gdplatam2000,
  author       = {de la Serna Tuya, Juan Moisés},
  title        = {GDP Evolution in Latin America 2000-2024: Interactive Dashboard},
  year         = {2026},
...
TI  - GDP Evolution in Latin America 2000-2024: Interactive Dashboard
PY  - 2026
PB  - GitHub
UR  - https://github.com/juanmoisesd/gdp-latam-2000-2024
...
### Vancouver / IEEE
```
de la Serna Tuya JM. GDP Evolution in Latin America 2000-2024: Interactive Dashboard. GitHub; 2026. Available: https://github.com/juanmoisesd/gdp-latam-2000-2024. ORCID: 0000-0002-8401-8018.
```
